# Google Slides style Commenting

In this demo, we are using Velt SDK to add commenting in a slides app.

![Sample App Slides](sample-app-slides.png "Sample Slides App")

## Features Used in Demo

- Commenting (Page Mode)
- Presence
- Sidebar
- Notifications
...
- [Page Comments](https://docs.velt.dev/async-collaboration/comments/setup/page)
